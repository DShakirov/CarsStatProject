...
from bot.handlers import static_text
from bot.models import User
from bot.utils import extract_user_data_from_update
from bot.handlers.keyboard_utils import make_keyboard_for_start_command, keyboard_confirm_decline_broadcasting
...
def command_start(update, context):
    ...
    text = 'Автомобили в Крыму дороже и дешевле рынка'
